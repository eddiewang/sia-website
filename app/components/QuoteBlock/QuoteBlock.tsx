  ...
  public render() {
    return (
      <div className={styles.QuoteBlock}>
        <Text type="quoteText">
          "Beyond their technical skills, what attracted us to Sia is the team’s commitment to
          decentralization and a value proposition that aligns investors' economic goals with
